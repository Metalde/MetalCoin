...
void BitcoinGUI::createActions()
{
    ...
    radioAction->setToolTip(tr("Listen to Metal Mosh Pit Radio"));
    radioAction->setCheckable(true);
    radioAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    tabGroup->addAction(radioAction);
    
    webshopAction = new QAction(QIcon(":/icons/webshop"), tr("&Metal Mosh Pit"), this);
    webshopAction->setToolTip(tr("Metal Mosh Pit"));
